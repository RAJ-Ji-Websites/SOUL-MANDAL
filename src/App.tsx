...
const teamMembers = [
  ...
  { name: 'Sudeep Verma', initials: 'SV', role: 'Design & Décor Lead', desc: 'The mind behind our magical setups. Sudeep brings visions to life with innovative décor, thematic styling, and artistic touches that make every event visually stunning.' },
